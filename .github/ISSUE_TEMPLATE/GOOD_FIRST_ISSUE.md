...
Welcome to the Digital Bone Box project! We're thrilled you're interested in contributing. This guide is designed to help you find and complete your first issue.
...
## Where to Start (Code Pointers)

- [Path/to/file/or/module]
- [Path/to/file/or/module]
- [Helpful function/class names]
...
- [ ] Well-defined: The goal is clear and the scope is small.
- [ ] Low-impact: They don't involve changing critical parts of the application.
...
Thank you for your interest in contributing to Digital Bone Box!
